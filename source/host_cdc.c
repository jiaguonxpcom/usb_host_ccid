...
void USB_HostCdcTask(void *param)
{
    ...
    switch (cdcInstance->runState)
    {
        ...
        case kUSB_HostCdcRunSetControlInterface:
            usb_echo(" s - kUSB_HostCdcRunSetControlInterface \r\n");
        ...
        case kUSB_HostCdcRunSetControlInterfaceDone:
            usb_echo(" s - kUSB_HostCdcRunSetControlInterfaceDone \r\n");
        ...
        case kUSB_HostCdcRunSetDataInterfaceDone:
            usb_echo(" s - kUSB_HostCdcRunSetDataInterfaceDone \r\n");
            g_AttachFlag          = 1;
            // cdcInstance->runState = kUSB_HostCdcRunGetStateDone;
            cdcInstance->runState = kUSB_HostCdcRunIdle;
...
*/
        ...
        case kUSB_HostCdcRunGetStateDone:
            usb_echo(" s - kUSB_HostCdcRunGetStateDone \r\n");
        ...
        case kUSB_HostCdcRunSetCtrlStateDone:
            usb_echo(" s - kUSB_HostCdcRunSetCtrlStateDone \r\n");
        ...
        case kUSB_HostCdcRunGetLineCodeDone:
            usb_echo(" s - kUSB_HostCdcRunGetLineCodeDone \r\n");
            cdcInstance->runState = kUSB_HostCdcRunIdle;
            break;
                              ...
                              uint32_t event_code)
{
 ...
 /*
            Decode class/interface information.
            CCID configuration descriptor structure:

            CONFIGURATION Descriptor (9 bytes) 
            INTERFACE Descriptor (9 bytes) 
            SMART CARD CLASS SPECIFIC DEVICE Descriptor (54 bytes) 
...
*/
        ...
        case kUSB_HostEventEnumerationDone:
            ...
            {
                if ((cdcDeviceHandle != NULL) && (cdcDataInterfaceHandle != NULL))
                {
